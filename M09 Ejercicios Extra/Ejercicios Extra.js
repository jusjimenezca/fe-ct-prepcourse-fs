...
function numberOfCharacters(string) {
   ...
   // Tu código:
      ...
      string.split('').forEach(letra => {
         nuevoString[letra] = nuevoString[letra] ? nuevoString[letra] + 1 : 1;
      });
      return Object.keys(nuevoString).sort().reduce((obj, key) => {
         obj[key] = nuevoString[key];
         return obj;
      }, {});
   }
...
function capToFront(string) {
   ...
   // Tu código:
   let mayusculas = string.split('').filter(letra => letra === letra.toUpperCase());
   let minusculas = string.split('').filter(letra => letra === letra.toLowerCase());
